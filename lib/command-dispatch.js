...
// rescue keystroke it has no PTY to receive.
export async function dispatchJournalRescueKeystroke(text, ivActive, { flushCursor, sendRescueKeystroke }) {
  if (!ivActive) return false;
