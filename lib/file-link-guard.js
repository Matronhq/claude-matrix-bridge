...
// Basename patterns from PR #54 verbatim. config.json is deliberate: this
// ecosystem's config.json files hold tokens (~/.claude-matrix-config.json).
// Path patterns: original five dot-dirs from PR #54 verbatim, plus three
// directory-segment patterns added in review to flag files inside sensitive
// directories (e.g., .env/apikey.dat, secrets/db.dat).
